...
// grafik section
$routes->get('/home/weekly', 'Home::weekly');
// $routes->get('/', 'Home::monthly');
// $routes->get('/', 'Home::yearly');

// prospect section
$routes->get('/prospect', 'Prospect::prospect');
$routes->get('/prospect/create', 'Prospect::create');
$routes->get('/prospect/edit/(:segment)', 'Prospect::edit/$1');
$routes->get('/prospect/delete/(:any)', 'Prospect::delete/$1');
$routes->get('/prospect/deleteAll', 'Prospect::deleteAll');
// $routes->get('/prospect/user/(:any)', 'Prospect:user/$1');

// applicant section
$routes->get('/applicant', 'Applicant::applicant');
$routes->get('/applicant/create', 'Applicant::create');
$routes->get('/applicant/edit/(:segment)', 'Applicant::edit/$1');
$routes->get('/applicant/delete/(:any)', 'Applicant::delete/$1');
// $routes->get('/applicant/user/(:any)', 'Applicant:user/$1');

// admitted section
$routes->get('/admitted', 'Admitted::admitted');
$routes->get('/admitted/create', 'Admitted::create');
$routes->get('/admitted/edit/(:segment)', 'Admitted::edit/$1');
$routes->get('/admitted/delete/(:any)', 'Admitted::delete/$1');
// $routes->get('/admitted/user/(:any)', 'Admitted::user/$1');

// enrollee section
$routes->get('/enrollee', 'Enrollee::enrollee');
$routes->get('/enrollee/create', 'Enrollee::create');
$routes->get('/enrollee/edit/(:segment)', 'Enrollee::edit/$1');
$routes->get('/enrollee/delete/(:any)', 'Enrollee::delete/$1');
$routes->get('/enrollee/user/(:alphanumeric)', 'Enrollee:user/$1');
