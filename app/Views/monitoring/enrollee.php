                            ...
                            <div class="col">
                                <div class="dropdown d-inline-block position-relative">
                                    <button type="button" class="btn header-item tambah_data" id="page-header-user-dropdown" aria-expanded="false">
                                        <span class="d-xl-inline-block mx-auto  fw-medium font-size-15">
                                            <a href="/enrollee/create" class="btn btn-success ms-3 py-2"><i class="uil uil-file-plus-alt font-size-15 align-middle me-1"></i><span> Add Data</span></a>
                                        </span>
                                    </button>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="/enrollee/upload_file" enctype="multipart/form-data">
                                ...
                                <div class="dropdown d-inline-block position-relative ">
                                    <button type="button" class="btn header-item template_file" id="page-header-user-dropdown" aria-expanded="false">
                                        <span class="d-xl-inline-block mx-auto  fw-medium font-size-15">
                                            <a href="/enrollee/template_file" target="_blank" class="btn btn-secondary"><i class="uil uil-file-download font-size-15 align-middle me-1"></i> <span class="align-middle">Template File</span></a>
                                        </span>
                                    </button>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table id="" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    ...
                                    <?php foreach ($enrollee as $e) : ?>
                                <tbody>
                                    <tr>
                                        <td>
                                            <input name="checkbox_value[]" type="checkbox" data-id="<?= $e['id']; ?>" value="<?= $e['id']; ?>" class="sub_chk">
                                        </td>
                                        <td>
                                            <?= $i++; ?>
                                        </td>
                                        <td class="text-center">
                                            <form action="/enrollee/user/<?= $e['id']; ?>" method="post" class="d-inline">
                                        ...
                                        <td>
                                            <div class="grid-container">
                                                <div class="grid-items">
                                                    <a href="/enrollee/edit/<?= $e['id']; ?>" class="btn btn-warning px-2"><i class="uil uil-pen font-size-18"></i></a>
                                                </div>
                                                <div class="grid-items">
                                                    <form action="/enrollee/delete/<?= $e['id']; ?> " method="post" class="d-inline">
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <button type="button" class="btn btn-danger px-2 waves-effect waves-light sa-warning-enrollee" value="<?= $e['id']; ?>"><i class="uil uil-trash-alt font-size-18"></i></button>
                                                    </form>
                                                </div>
                                            </div>
                                        </td>
                            ...
                            <?= $pager->links('enrollee', 'enrollee_pagination');
                            ?>
                        </div>
