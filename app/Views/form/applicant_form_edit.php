    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="/applicant/update/<?= $mahasiswa['id']; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <fieldset disabled="disabled">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control <?= (session('validation')) ? 'is-invalid' : ''; ?>" id="disabledTextInput" placeholder="Lunas" name="status_pembayaran" value="<?= old('status_pembayaran') ? old('status_pembayaran') : $mahasiswa['status_pembayaran']; ?>">
                            ...
                            <div class="btn-group position-relative start-50 top-100 translate-middle mt-5">
                                ...
                                <div class="dropdown-menu">
                                    <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#myModal">Fill Form Admitted</button>
                                </div>
                            </div><!-- /btn-group -->
                                ...
                                <div class="modal-dialog w-100">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="myModalLabel">Form Admitted</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form method="post" action="/applicant/update/<?= $mahasiswa['id']; ?>" enctype="multipart/form-data">
