    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="/admitted/update/<?= $mahasiswa['id']; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <fieldset disabled="disabled">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control <?= (session('validation')) ? 'is-invalid' : ''; ?>" id="disabledTextInput" placeholder="Lunas" name="status_pembayaran" value="<?= old('status_pembayaran') ? old('status_pembayaran') : $mahasiswa['status_pembayaran']; ?>">
                            ...
                            <!-- <button type="submit" class="btn btn-success position-relative start-50 top-100 translate-middle mt-5 px-4 py-2 fw-bold" style="width: 300px;" onclick="window.confirm('Ubah Data ?')">Update Data</button> -->

                            <div class="btn-group position-relative start-50 top-100 translate-middle mt-5">
                                <button type="submit" class="btn btn-success waves-effect waves-light mt-2 py-2 fw-bold" style="width: 200px;">Update Data</button>
                                <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split waves-effect waves-light mt-2 py-2" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="mdi mdi-chevron-down fw-bolder"></i>
                                </button>
                                <div class="dropdown-menu">
                                    <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#myModal">Fill Form Enrollee</button>
                                </div>
                            </div><!-- /btn-group -->
                                ...
                                <div class="modal-dialog w-100">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="myModalLabel">Form Enrollee</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form method="post" action="/admitted/update/<?= $mahasiswa['id']; ?>" enctype="multipart/form-data">
