    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="/admitted/save" method="post" enctype="multipart/form-data">
                            ...
                            <fieldset disabled>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control <?= (session('validation')) ? 'is-invalid' : ''; ?>" id="disabledTextInput" placeholder="Lunas" name="status_pembayaran" value="<?= old('status_pembayaran'); ?>">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control <?= (session('validation')) ? 'is-invalid' : ''; ?>" id="no_formulir" name="no_formulir" value="<?= old('no_formulir'); ?>">
                            ...
                            <button type="submit" class="btn btn-success position-relative start-50 top-100 translate-middle mt-5 px-4 py-2 fw-bold" style="width: 300px;">Tambah Data</button>
                        </form>
                    </div>
                </div>
            </div>
