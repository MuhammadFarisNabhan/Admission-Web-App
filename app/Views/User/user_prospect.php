                                ...
                                <div class="dropdown float-end">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <form action="#" method="post">
                                            <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalEdit0">Edit</button>
                                        </form>
                                        <!-- <a class="dropdown-item" href="#">Edit</a> -->
                                        <form action="/prospect/delete/<?= $m['id']; ?>" method="post">
                                            <button type="button" class="dropdown-item sa-warning-prospect" value="<?= $m['id']; ?>">Hapus</button>
                                        </form>
                                    </div>
                                    <div id="modalEdit0" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="myModalLabel">Edit Prospect</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="/prospect/update_user/<?= $m['id']; ?>" method="post" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset disabled="disabled">
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <select class="form-select <?= (session('validation')) ? 'is-invalid' : ''; ?>" id="status_pembayaran" name="status_pembayaran" value="<?= old('status_pembayaran') ? old('status_pembayaran') : $m['status_pembayaran']; ?>">
                    ...
                    <div class="card mb-0">
                        ...
                        <div class="tab-content p-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="position-relative">
                                            <div class="d-inline progress">
                                                <button type="button" class="btn stages sa-prospect-message" style="background-color: <?= ($m['status'] >= 0) ? '#5b73e8' : '#6C757D'; ?> ; ">Prospect</button>
                                                <button class="btn stages" data-bs-toggle="modal" data-bs-target="#modalApplicant" style="background-color: <?= ($m['status'] >= 1) ? '#5b73e8' : '#6C757D'; ?> ; ">Applicant</button>
                                                <button type="button" class="btn stages sa-admitted-message" style="background-color: <?= ($m['status'] >= 2) ? '#5b73e8' : '#6C757D'; ?> ; ">Admitted</button>
                                                <button type="button" class="btn stages sa-enrollee-message" style="background-color: <?= ($m['status'] >= 3) ? '#5b73e8' : '#6C757D'; ?> ; ">Enrollee</button>
                                            </div>
                                            <div id="modalProspect" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p><?= $m['nama']; ?> berada di tahap Prospect</p>
                                                        </div>
                                                    </div><!-- /.modal-content -->
                                                </div><!-- /.modal-dialog -->
                                            </div><!-- /.modal -->
                                            <div id="modalApplicant" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="/prospect/update_change_stages/<?= $m['id']; ?>" enctype="multipart/form-data">
                                                                <div class="form-group">
                                                                    <?= csrf_field(); ?>
                                                                    <div class="row mb-3">
                                            ...
                                            <div id="modalAdmitted" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p><?= $m['nama']; ?> harus mengisi field Applicant.</p>
                                                        </div>
                                                    </div><!-- /.modal-content -->
                                                </div><!-- /.modal-dialog -->
                                            </div><!-- /.modal -->
                                            <div id="modalEnrollee" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p><?= $m['nama']; ?> harus mengisi field Admitted.</p>
                                                        </div>
                                                    </div><!-- /.modal-content -->
                                                </div><!-- /.modal-dialog -->
                                            </div><!-- /.modal -->
                            ...
                            <div class="tab-pane" id="activity" role="tabpanel">
                                <div>
                                    <ul class="nav nav-justified ms-3" role="tablist">
                                        <!-- Email -->
                                        ...
                                        <div class="d-inline-block mb-4">
                                            <button type="button" class="btn bg-warning waves-effect" data-bs-toggle="modal" data-bs-target="#ModalLogCall" role="tab"><i class="uil uil-phone fs-5"></i> <span> Call</span></button>
                                            <!-- <div class="btn-group">
