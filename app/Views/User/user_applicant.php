                                ...
                                <div class="dropdown float-end">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <form action="#" method="post">
                                            <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalEdit1">Edit</button>
                                        </form>
                                        <form action="/applicant/delete/<?= $m['id']; ?>" method="post">
                                            <button type="button" class="dropdown-item sa-warning-applicant" value="<?= $m['id']; ?>">Hapus</button>
                                        </form>
                                    </div>
                                    <div id="modalEdit1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="myModalLabel">Edit Applicant</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="/applicant/update_user/<?= $m['id']; ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div>
                                        ...
                                        <div class="position-relative">
                                            <div class="d-inline progress">
                                                ...
                                                <button class="btn stages" data-bs-toggle="modal" data-bs-target="#modalAdmitted" style="background-color: <?= ($m['status'] >= 2) ? '#5b73e8' : '#6C757D'; ?> ; ">Admitted</button>
                                                <button type="button" class="btn stages sa-enrollee-message" value="<?= $m['status']; ?>" style="background-color: <?= ($m['status'] >= 3) ? '#5b73e8' : '#6C757D'; ?> ; ">Enrollee</button>
                                            </div>
                                            ...
                                            <div id="modalApplicant" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p><?= $m['nama']; ?> berada di tahap Applicant</p>
                                                        </div>
                                                    </div><!-- /.modal-content -->
                                                </div><!-- /.modal-dialog -->
                                            </div><!-- /.modal -->
                                            <div id="modalAdmitted" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="/applicant/update_change_stages/<?= $m['id']; ?>" enctype="multipart/form-data">
                                                                <div class="form-group">
                                                                    <?= csrf_field(); ?>
                                                                    <div class="row mb-3">
